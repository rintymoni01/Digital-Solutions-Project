...
const AboutCategory = () => {
    return (
        <div className='pt-30 bg-[#060606] text-white'>

                           <div>
                            <div className='container mx-auto flex flex-col items-center justify-center text-center'>
                             <h3 className='text-3xl font-bold mb-2'>About Me</h3>
                             <div className='flex gap-2 items-center'>
                               <p className='text-sm hover hover:text-[#FF014F]'>About</p>
                               <IoMdArrowDropright className='text-sm'/>
                               <p className='text-sm text-[#FF014F]'>About Me</p>
                             </div>
                           </div>
                           </div>
                           ...
                           <div>
                            <div className="container mx-auto pt-20 px-26">
